    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center"><b>ลบรายการสินค้า</b></h4>
            </div>
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="products_edit.php">
                ...
                <div class="form-group">
                  ...
                  <label for="edit_category" class="col-sm-1 control-label">ประเภท</label>
                ...
                <div class="form-group">
                  ...
                  <label for="edit_amount" class="col-sm-1 control-label">จำนวน</label>
