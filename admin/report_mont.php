...
<div class="wrapper">
  ...
  include 'includes/menubar.php'; 
    ...
    if(strlen($getmonth) == 0 ){
      
      $m = '01';
      $y = '2022';
    }else{
      $y = substr($getmonth, 0, -3);
      $m = substr($getmonth, 5);
    }
          ...
          <div class="box">
            <div class="box-header with-border">
              <div class="pull-right">
               เลือกเดือน : 
              <input type="month" id="select_month" value=<?php echo $y."-".$m;  ?>>
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      ...
                      WHERE MONTH(sales.sales_date) = $m and YEAR(sales.sales_date) = $y ");
                      $stmt->execute();
                      foreach($stmt as $row){
...
$(function(){
  $('#select_month').change(function(){
    window.location.href = 'report_mont.php?month='+$(this).val();
  });
});
</script>
