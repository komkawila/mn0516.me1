        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew_em" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> เพิ่มพนักงาน</a>
            </div>
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM users WHERE type = 2 ;");
                      $stmt->execute(['type'=>0]);
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            <td>
                              ...
                              <span class='pull-right'><a href='#edit_photoem' class='photo' data-toggle='modal' data-id='".$row['id']."'><i class='fa fa-edit'></i></a></span>
                            </td>
                            <td>".$row['email']."</td>
