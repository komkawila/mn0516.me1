		            	...
		            	<div class="col-sm-6">
		            		...
		            		<form class="form-inline" id="productForm">
		            			<div class="form-group">
			            			...
			            			<button type="submit" class="btn btn-success btn-lg " <?php if($product['product_stock']==0){ ?>disabled <?php } ?>><i class="fa fa-shopping-cart"></i> เพิ่มสินค้าในตะกร้า</button>
			            		</div>
		            		</form>
		            	</div>
		            	<div class="col-sm-6">
		            		<h1 class="page-header"><?php echo $product['prodname']; ?> บาท</h1>
		            		<h3><b>ราคา <?php echo number_format($product['price'], 2); ?></b></h3>
		            		<h4><b>จำนวน : <?php echo $product['product_stock']; ?> ชิ้น</b></h4>
