...
<div class="register-box">
    ...
    ?>
  	<div class="register-box-body">
    	<h4 class="login-box-msg text-success">สมัครสมาชิก</h4>
    	...
    	<form action="register.php" method="POST">
          ...
          <hr>
            ...
            <div class="col-sm-6">
                  <button type="submit" class="btn btn-success btn-block btn-flat" name="signup"><i class="fa fa-pencil"></i> สมัคสมาชิก</button>
            </div>
      		</div>
    	</form>
      <br>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 text-right">
          <a href="login.php" class="text-success ml-10"><i class="fa fa-sign-in"></i> login</a>
        </div>
      </div>
